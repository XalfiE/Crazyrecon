...
echo -e "
 ...
 C:::::C       CCCCCCrrrrr   rrrrrrrrr   aaaaaaaaaaaaa   zzzzzzzzzzzzzzzzzyyyyyyy           yyyyyyyR::::R     R:::::R    eeeeeeeeeeee        cccccccccccccccc   ooooooooooo   nnnn  nnnnnnnn    
C:::::C              r::::rrr:::::::::r  a::::::::::::a  z:::::::::::::::z y:::::y         y:::::y R::::R     R:::::R  ee::::::::::::ee    cc:::::::::::::::c oo:::::::::::oo n:::nn::::::::nn  
C:::::C              r:::::::::::::::::r aaaaaaaaa:::::a z::::::::::::::z   y:::::y       y:::::y  R::::RRRRRR:::::R  e::::::eeeee:::::ee c:::::::::::::::::co:::::::::::::::on::::::::::::::nn 
C:::::C              rr::::::rrrrr::::::r         a::::a zzzzzzzz::::::z     y:::::y     y:::::y   R:::::::::::::RR  e::::::e     e:::::ec:::::::cccccc:::::co:::::ooooo:::::onn:::::::::::::::n
C:::::C               r:::::r     r:::::r  aaaaaaa:::::a       z::::::z       y:::::y   y:::::y    R::::RRRRRR:::::R e:::::::eeeee::::::ec::::::c     ccccccco::::o     o::::o  n:::::nnnn:::::n
C:::::C               r:::::r     rrrrrrraa::::::::::::a      z::::::z         y:::::y y:::::y     R::::R     R:::::Re:::::::::::::::::e c:::::c             o::::o     o::::o  n::::n    n::::n
C:::::C               r:::::r           a::::aaaa::::::a     z::::::z           y:::::y:::::y      R::::R     R:::::Re::::::eeeeeeeeeee  c:::::c             o::::o     o::::o  n::::n    n::::n
 C:::::C       CCCCCC r:::::r          a::::a    a:::::a    z::::::z             y:::::::::y       R::::R     R:::::Re:::::::e           c::::::c     ccccccco::::o     o::::o  n::::n    n::::n
  C:::::CCCCCCCC::::C r:::::r          a::::a    a:::::a   z::::::zzzzzzzz        y:::::::y      RR:::::R     R:::::Re::::::::e          c:::::::cccccc:::::co:::::ooooo:::::o  n::::n    n::::n
   CC:::::::::::::::C r:::::r          a:::::aaaa::::::a  z::::::::::::::z         y:::::y       R::::::R     R:::::R e::::::::eeeeeeee   c:::::::::::::::::co:::::::::::::::o  n::::n    n::::n
     CCC::::::::::::C r:::::r           a::::::::::aa:::az:::::::::::::::z        y:::::y        R::::::R     R:::::R  ee:::::::::::::e    cc:::::::::::::::c oo:::::::::::oo   n::::n    n::::n
        CCCCCCCCCCCCC rrrrrrr            aaaaaaaaaa  aaaazzzzzzzzzzzzzzzzz       y:::::y         RRRRRRRR     RRRRRRR    eeeeeeeeeeeeee      cccccccccccccccc   ooooooooooo     nnnnnn    nnnnnn
                                                                                y:::::y                                                                                                         
                                                                               y:::::y                                                                                                          
                                                                              y:::::y                                                                                                           
                                                                             y:::::y                                                                                                            
...
${RED}$VERSION${RESET} by ${YELLOW}Alfie(http://the-infosec.com)${RESET}
"
}
...
enumSubs(){
    ...
    runBanner "Amass"
    ~/go_projects/bin/amass enum -d $TARGET -o $SUB_PATH/amass.txt

    #runBanner "subfinder"
    #~/go_projects/bin/subfinder -d $TARGET -t 50 -b -w $WORDLIST_PATH/dns_all.txt $TARGET -nW --silent -o $SUB_PATH/subfinder.txt
    ...
    runBanner "subjack"
    ~/go_projects/bin/subjack -a -ssl -t 50 -v -c ~/go_projects/src/github.com/haccer/subjack/fingerprints.json -w $SUB_PATH/final-subdomains.txt -o $SUB_PATH/final-takeover.tmp
...
visualRecon(){
    ...
    runBanner "aquatone"
    cat $SUB_PATH/final-subdomains.txt | ~/go_projects/bin/aquatone -http-timeout 10000 -scan-timeout 300 -ports xlarge -out $SSHOT_PATH/aquatone/
